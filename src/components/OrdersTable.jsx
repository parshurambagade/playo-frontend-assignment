        ...
        <table className="text-sm w-full">
            <thead>
                <tr className="p-4 grid grid-cols-8 w-full justify-between gap-4 bg-white text-sm leading-[17.07px] items-center font-bold">
                    ...
                    <th className=" flex justify-between"><span>Product</span><span><img src="./assets/caret-up-down.svg" className="h-4 w-4 cursor-pointer" alt="caret-up-down" /></span></th>
                    <th className="flex justify-between"><span>Customer</span><span><img src="./assets/caret-up-down.svg" className="h-4 w-4 cursor-pointer" alt="caret-up-down" /></span></th>
                    <th className="flex justify-between"><span>Date</span><span><img src="./assets/caret-up-down.svg" className="h-4 w-4 cursor-pointer" alt="caret-up-down cursor-pointer" /></span></th>
            ...
            <tbody>
                {orders.map(order => (
                    ...
                    <img src="./assets/trash.svg" className="h-6 w-6 cursor-pointer" alt="trash" />
</td>
                    </tr>   
                ))}
            </tbody>
